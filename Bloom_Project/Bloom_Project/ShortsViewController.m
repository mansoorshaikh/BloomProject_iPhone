...
- (void)viewDidLoad {
    ...
    if (UI_USER_INTERFACE_IDIOM()==UIUserInterfaceIdiomPad) {
        [shortTableView removeFromSuperview];
        shortTableView=[[UITableView alloc]initWithFrame:CGRectMake(0,110,self.view.bounds.size.width,self.view.bounds.size.height-360)];
        shortTableView.backgroundColor=[UIColor clearColor];
        self.shortTableView.separatorColor = [UIColor clearColor];
        [self.view addSubview:shortTableView];
        [self.view bringSubviewToFront:shortTableView];
    ...
    if(height>=480 && height<568){
        ...
        [shortTableView removeFromSuperview];
        shortTableView=[[UITableView alloc]initWithFrame:CGRectMake(0,110,self.view.bounds.size.width,self.view.bounds.size.height-265)];
        shortTableView.backgroundColor=[UIColor clearColor];
        self.shortTableView.separatorColor = [UIColor clearColor];
        [self.view addSubview:shortTableView];
        [self.view bringSubviewToFront:shortTableView];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SeriesVO *serVO=[shortArray objectAtIndex:indexPath.row];
